...
def main(): #main function
    ...
    with requests.Session() as c:
        url        =      'http://kroseii.bigcartel.com/'
        wait_time  =      120 #customizable time to wait to check for changes IE every 5 secs

        user            = 'user@gmail.com' #emailuser@gmail.com
        pwd             = 'ejfj fjwi ofkw odif'  #app password generated by google IE "djfj rubi sifu sofi"
        recipient       = 'recip@gmail.com' #recievingemail@gmail.com
